...
const RegistrationForm = () => {
  ...
  const userTypeOptions = [
    { value: 'homeowner', label: 'Homeowner', description: 'Individual managing home environment' },
    { value: 'professional', label: 'Professional', description: 'Agricultural or environmental professional' },
    { value: 'researcher', label: 'Researcher', description: 'Academic or scientific researcher' },
    { value: 'corporate', label: 'Corporate', description: 'Corporate sustainability manager' }
  ];
